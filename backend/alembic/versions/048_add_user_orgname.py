"""048_add_user_orgname

添加用户部门名称字段

Revision ID: 20251202001
...
revision = '20251202001'
down_revision = 'c1b794a961ce'  # 修改为当前最新的 revision ID
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    table_name = 'sys_user'
    column_name = 'orgname'  # 替换为你要添加的字段名
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            comment='部门名称'  # 字段注释（PostgreSQL 支持）
        )
    )
