...
import Person from '@/components/layout/Person.vue' 
...
function onClickSideBarBtn() {
  console.log('[ chat-list-heade ] >',99)
...
<template>
  <el-container class="chat-container-right-container">
    <el-header class="chat-list-header" :class="{ 'in-popover': inPopover }">
      ...
      <el-button v-if="false" class="btn" type="primary" @click="createNewChat">
    ...
    <el-main class="chat-list">
      ...
      <ChatList
        ...
        @on-click-side-bar-btn="onClickSideBarBtn"
      />
    </el-main>
    <el-footer>
    <div><Person :collapse="collapse" :inSysmenu="inSysmenu"></Person></div>
    </el-footer>
